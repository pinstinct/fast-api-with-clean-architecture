...
class NoteService:
    def __init__(self, note_repo: InterfaceNoteRepository):  # NoteRepository 객체 주입 받음
    ...
    def update_note(self, user_id: str, id: str, title: str | None = None,
                    content: str | None = None, memo_date: str | None = None,
    ...
    def get_notes_by_tag(self, user_id: str, tag_name: str, page: int,
                         items_per_page: int,) -> tuple[int, list[Note]]:
        return self.note_repo.get_notes_by_tag_name(
            user_id=user_id, tag_name=tag_name, page=page, items_per_page=items_per_page)
